...
| --- | --- | --- | --- |
| Загрузка аудиозаписи и видеозаписи (§3.1) | P0 | Streamlit, API, файловое хранилище | Запланировано |
| Подготовка аудио для моделей (инженерный шаг из запроса) | P0 | ffmpeg adapter | Запланировано |
| Speech-to-text, F-01 | P0 | faster-whisper adapter | Запланировано; модель не проверена |
| Русский язык, F-02 | P0 | STT, анализ, демонстрационные данные | Не проверено |
| Казахский язык, F-03 | P0 | STT, анализ, демонстрационные данные | Не проверено |
| Смешанная RU/KZ речь, F-04 | P0 | STT, анализ, демонстрационные данные | Не проверено |
| Диаризация, F-06 | P0 | pyannote adapter | Запланировано; доступ к весам не проверен |
| Привязка речи и поручений к конкретным участникам, F-06 | P0 | Alignment, сопоставление участников, анализ | Запланировано |
| Транскрипт и структурированный список поручений, F-09 | P0 | Схемы, API, UI, SQLite | Запланировано |
| Извлечение сути поручений, F-05 | P0 | Локальная LLM через Ollama | Запланировано |
| Ответственный: человек либо указанное подразделение, F-05, §9 | P0 | Анализ и валидация | Запланировано |
| Срок поручения, F-05; сохранение неопределенности по §9 | P0 | Анализ и обработка дат | Запланировано |
| Итоговое summary, F-08 | P0 | Локальная LLM, UI | Запланировано |
